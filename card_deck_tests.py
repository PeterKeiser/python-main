...
from cards3 import Card
from deck3 import Deck
import unittest
...
class DeckTests(unittest.TestCase):
    ...
    def test_init(self):
        """deck should have a cards attribute, which is a ..."""
        self.assertTrue(isinstance(self.deck.cards, list))
        self.assertEqual(len(self.deck.cards), 52)

    def test_repr(self):
        """repr should return a string of the form "Deck of ..." """
    ...
    def test_deal_insufficient_cards(self):
        """_deal should deal the number of cards left in the ..."""
        cards = self.deck._deal(100)
        self.assertEqual(len(cards), 52)
        self.assertEqual(self.deck.count(), 0)

    def test_deal_no_cards(self):
        """_deal should throw a ValueError if deck is ..."""
